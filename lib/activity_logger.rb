module ActivityLogger
  ...
  def add_activities(options = {})
    ...
    user_ids = user_to_add(user, activity, include_user)
  ...
  # Return the ids of user who already have the given feed activity.
